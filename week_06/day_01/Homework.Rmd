...
con_crew <- titanic %>% 
  ...
  summarise(mean(survived))
```
the conditional chance of survival for passengers is 0.3250802, crew members is 0.07692308. so you were more likely to be a surviving crew member than a surviving passenger.
